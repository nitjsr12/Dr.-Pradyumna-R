...
export const images = {
  ...
  sportsMedicine: local("/images/sections/sports-medicine-placeholder.jpg"),
  orthopaedics: local("/images/sections/orthopaedics-placeholder.jpg"),
  knee: local("/images/sections/knee-placeholder.jpg"),
  shoulder: local("/images/sections/shoulder-placeholder.jpg"),
  ...
  clinic: local("/images/sections/clinic-placeholder.jpg"),
